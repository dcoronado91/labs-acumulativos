    ...
    Scaffold(
        ...
        NavHost(
            ...
            composable(
                ...
                CharacterDetailScreen(onBack = { navController.popBackStack() }, navBackStackEntry = backStackEntry)
            }
            ...
            composable(
                ...
                LocationDetailScreen(onBack = { navController.popBackStack() }, navBackStackEntry = backStackEntry)
            }
            composable("profile") {
